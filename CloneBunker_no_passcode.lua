...
-- ================= STATE =================
local selectedPlayer=nil;local isLocked=false;local passEntry="";local isCloning=false
...
local function openSettingsApp()
    ...
    alTitle.BackgroundTransparency=1; alTitle.Text="Auto Lock (disabled) Timer"
    ...
    alSave.MouseButton1Click:Connect(function()
        ...
        persistSettings()
        showDynamicNotification("Auto Lock (disabled): "..appSettings.autoLockSeconds.."s", T.Green)
    end)
